                ...
                <div>
                    ...
                    <div className="bg-gray-300 dark:bg-gray-700 rounded-lg p-6">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <span
                                className={
                                    "bg-blue-500/20 text-blue-600 dark:text-blue-400 px-3 py-1 rounded-full text-sm " +
                                    `${!active ? "hidden" : ""}`
                                }
                            >
                                Active
                        ...
                        <div className="flex">
                            <button className="border border-gray-400 dark:border-gray-600 hover:bg-gray-400 dark:hover:bg-gray-600 hover:text-gray-100 px-4 py-2 rounded-lg">
                                Cancel Plan
                            </button>
                        </div>
                    </div>
                                        ...
                                        <td className="p-4">
                                            <span
                                                className={
                                                    ...
                                                    `${
                                                        h.paid
                                                            ? "dark:bg-green-500/20 bg-green-500 text-white dark:text-green-400"
                                                            : "dark:bg-red-500/20 bg-red-400 text-white dark:text-red-400"
                                                    }`
                                                }
                                            >
                                                {h.paid ? "Paid" : "Unpaid"}
