                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    type="text"
                                    className="w-full bg-gray-300 dark:bg-gray-700 rounded-lg px-4 py-2 pl-10"
                                    ...
                                    required
                                />
                                <User className="absolute left-3 top-2.5 h-5 w-5 text-gray-600 dark:text-gray-400" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                />
                                <Mail className="absolute left-3 top-2.5 h-5 w-5 text-gray-600 dark:text-gray-400" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    required
                                />
                                <Lock className="absolute left-3 top-2.5 h-5 w-5 text-gray-600 dark:text-gray-400" />
                            </div>
                        </div>
                ...
                <span className="ml-2 text-sm text-gray-400">
                  ...
                  >
                    Privacy Policy
                        ...
                        <button
                            type="submit"
                            className="w-full bg-blue-600 hover:bg-blue-500 dark:hover:bg-blue-700 text-white py-2 rounded-lg font-semibold"
                        >
                            Create Account
                        </button>
                    </form>
