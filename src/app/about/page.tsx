  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 pt-24 pb-12 text-black dark:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mission Section */}
        <div className="bg-gray-200 dark:bg-gray-800 rounded-2xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div className="bg-gray-200 dark:bg-gray-800 p-6 rounded-xl text-center">
            <div className="text-3xl font-bold text-blue-500 mb-2">50+</div>
            <div className="text-gray-600 dark:text-gray-400">Global Locations</div>
          </div>
          <div className="bg-gray-200 dark:bg-gray-800 p-6 rounded-xl text-center">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={member.name} className="bg-gray-200 dark:bg-gray-800 p-6 rounded-xl">
                <img
                  src={member.image}
                  alt={member.name}
